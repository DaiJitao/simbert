...
if isLinux:
	...
	datapath = '../data/'
# 加载数据集
train_data = load_data(datapath + 'test_data_1bai.txt')
valid_data = load_data(datapath + 'test_data_1bai.txt')
...
if __name__ == '__main__':
	train = False
	savedir='model'
	modelname="qtSim_twinNetword_{epoch:02d}_{sparse_categorical_accuracy:.3f}.h5"
	...
	if True:
		...
		outputs = Dense(3, activation=tf.nn.softmax, kernel_initializer=bert.initializer, name='output')(all_vec)
