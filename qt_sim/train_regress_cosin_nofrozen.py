...
savedir = 'model'
datadir = 'data'
filepath = "qtSim_cosin_nofrozen_{epoch:02d}_{mae:.4f}.h5"
modelfile = os.path.join(savedir, filepath)
trainf, testf, validatef = datadir + '/train_data_nofrozen.txt', datadir + '/test_data_nofrozen.txt', datadir + '/validate_data_nofrozen.txt'
